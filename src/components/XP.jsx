        ...
        >
          ...
          <div  ref={ulRef}className ="-my-">
            ...
            <div className ={`relative p-9 sm:pl-32 py-4 pl-6 pr-10 group  ${inView ? "animate-slidein2" : "opacity-0"}`}>
              ...
              <img src="public/Logos/Sacred_Heart_University.png" alt="ASML_logo" className=" w-36 border-10 border-white bg-transparent "/>
            ...
            <div className ={`relative  p-9 sm:pl-32 py-4 pl-6 pr-10 group  ${inView ? "animate-slidein3" : "opacity-0"}`}>
              ...
              <img src="public/Logos/Sikorsky_Aircraft_Logo.svg.png" alt="ASML_logo" className=" w-36 border-10 border-white bg-transparent "/>
