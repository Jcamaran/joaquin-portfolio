class Spotlight {
    ...
    onMouseMove(event) {
        ...
        // Correct the calculation of x and y by directly subtracting rect.left and rect.top
        ...
        if (inside) {
          ...
          // Adjust cardX and cardY to ensure the spotlight aligns with the mouse position
